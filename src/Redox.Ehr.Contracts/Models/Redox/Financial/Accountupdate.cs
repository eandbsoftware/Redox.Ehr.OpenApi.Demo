...
namespace Redox.Ehr.Contracts.Models.Redox.Financial.Accountupdate
{
    ...
    public partial class Procedures 
    {
        ...
        [Newtonsoft.Json.JsonProperty("PerformedDateTime", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
