...
namespace Redox.Ehr.Contracts.Models.Redox.Inventory.Deplete
{
    ...
    public partial class Items 
    {
        ...
        [Newtonsoft.Json.JsonProperty("WastedQuantity", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? WastedQuantity { get; set; }
