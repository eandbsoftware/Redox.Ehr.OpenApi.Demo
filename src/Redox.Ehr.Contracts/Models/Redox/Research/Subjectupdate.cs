...
namespace Redox.Ehr.Contracts.Models.Redox.Research.Subjectupdate
{
    ...
    {
        [Newtonsoft.Json.JsonProperty("SubjectStatus", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
