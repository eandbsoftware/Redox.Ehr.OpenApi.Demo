...
namespace Redox.Ehr.Contracts.Models.Redox.Research.Study
{
    ...
    public partial class Study1 
    {
        ...
        [Newtonsoft.Json.JsonProperty("Sponsor", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public Sponsor Sponsor { get; set; }
    
        [Newtonsoft.Json.JsonProperty("PrincipalInvestigator", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public PrincipalInvestigator PrincipalInvestigator { get; set; }
    
        [Newtonsoft.Json.JsonProperty("Coordinators", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Coordinators> Coordinators { get; set; }
        ...
        [Newtonsoft.Json.JsonProperty("Design", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    public partial class Protocols 
    {
        ...
        public System.Collections.Generic.ICollection<Cycles> Cycles { get; set; }
    ...
    public partial class Procedures 
    {
        ...
        [Newtonsoft.Json.JsonProperty("Modifers", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<object> Modifers { get; set; }
