...
namespace Redox.Ehr.Contracts.Models.Redox.Results.Query
{
    ...
    public partial class Query 
    {
        ...
        [Newtonsoft.Json.JsonProperty("ResultStatuses", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<object> ResultStatuses { get; set; }
    
        [Newtonsoft.Json.JsonProperty("OrderIDs", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<object> OrderIDs { get; set; }
